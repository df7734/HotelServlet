...
<div id="image" class="bg-image"
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col" style="padding-top: 30px">
                                <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
                                    <div class="carousel-inner" style=" width:100%; height: 400px !important;">
                                        <div class="carousel-item active"
                                             style="-webkit-transition: 0.2s !important; -o-transition: 0.2s !important; transition: 0.2s !important;">
                                            <img src="https://www.filoxenianews.gr/wp-content/uploads/2021/10/w-doha-qatar-suite-min-1024x683.jpg"
                                                 class="d-block w-100" alt="...">
                                        </div>
                                        <div class="carousel-item"
                                             style="-webkit-transition: 0.2s !important; -o-transition: 0.2s !important; transition: 0.2s !important;">
                                            <img src="https://64.media.tumblr.com/803e280930d1f33d9355a6a24487ce6b/tumblr_mkbjznj6Pt1r2doe0o1_r1_1280.jpg"
                                                 class="d-block w-100" alt="...">
                                        </div>
                                        <div class="carousel-item"
                                             style="-webkit-transition: 0.2s !important; -o-transition: 0.2s !important; transition: 0.2s !important;">
                                            <img src="https://527019-1677762-raikfcquaxqncofqfm.stackpathdns.com/wp-content/uploads/2021/06/shutterstock_680258509-1024x681.jpg"
                                                 class="d-block w-100" alt="...">
                                        </div>
                                    </div>
                                ...
                                <h5 class="card-text"
                                    style="color: teal; text-align: justify; text-indent: 25px; padding-bottom: 20px">
                                    You’ll notice it the instant you walk in –
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            ...
                                            <div class="card text-center">
                                                <div class="card-body">
                                                    <h5 class="card-title text-danger text-capitalize">Book your Comfort
                                                        room</h5>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col">
                                                                <select class="form-select" name="capacity"
                                                                        id="capacity"
                                                                        aria-label="Default select example">
                                                                    <option selected="selected" hidden="hidden">Number
                                                                        of persons
                                                                    </option>
                                            ...
                                            <div class="card text-center">
                                                <div class="card-body">
                                                    <h5 class="card-title text-primary text-capitalize">Or Choose the
                                                        exact room you want</h5>
                                                    <div class="row">
                                                        <div class="col-12 text-center">
                                                            <input type="button" class="btn btn-primary text-end"
                                                                   value="Show rooms list" onmousedown="viewTable()">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form action="book" method="post" autocomplete="off">
                            ...
                            <h3 style="display: inline">Room № </h3>
                            <h3 style="display: inline" id="roomNo">?</h3>
    ...
    <section id="table">
        <div class="container-xxl">
            <div class="card">
                <button type="button" class="btn-close align-self-end mt-4 me-4" aria-label="Close"
                        onmousedown="hideTable()"></button>
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-8">
                            ...
                            <table class="table table-striped table-hover" id="sortTable">
                                ...
                                <tbody>
                                <%
                                    List<Room> list = RoomsDao.getRoomsByClass("comfort");
                                    for (Room room: list) {
                                %>
                                <tr>
