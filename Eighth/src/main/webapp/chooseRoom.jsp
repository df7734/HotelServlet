            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-8">
                            <h6>Standard rooms for order №<%=session.getAttribute("orderId")%> with capacity <%=session.getAttribute("capacity")%> and class <%=session.getAttribute("class")%></h6>
                            <h4><%=session.getAttribute("firstDate")%> - <%=session.getAttribute("secondDate")%></h4>
                            <table class="table table-striped table-hover" id="sortTable">
                                <thead>
                                <tr>
                                    <td><h5 style="margin-left: 50px">number</h5></td>
                                    <td><h5 style="margin-left: 50px">capacity</h5></td>
                                    <td><h5 style="margin-left: 50px">class</h5></td>
                                    <td><h5 style="margin-left: 50px">price</h5></td>
                                    <td><h5 style="margin-left: 40px">status</h5></td>
                                    <td><h5 style="margin-left: 3px"></h5></td>
                                </tr>
                                </thead>
                                <tbody>
                                <%
                                    List<Room> rooms = RoomsDao.getRoomsByCapacityAndClass((String) session.getAttribute("capacity"),
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <input hidden name="roomId" value="<%=room.getId()%>">
                                    ...
                                    %>
                                    <td><button disabled type="button" class="btn btn-outline-secondary">Occupied</button></td>
                                    <%
                                        }
                                    %>
                                </tr>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-8">
                            <h4>Schedule</h4>
                            <table class="table table-striped table-hover" id="sortTable2">
                                <thead>
                                <tr>
                                    <td><h5 style="margin-left: 3px">room</h5></td>
                                    <td><h5 style="margin-left: 10px">check-in</h5></td>
                                    <td><h5 style="margin-left: 10px">check-out</h5></td>
                                    <td><h5 style="margin-left: 10px">status</h5></td>
                                    <td><h5 style="margin-left: 30px">expire</h5></td>
                                </tr>
                                </thead>
                                <tbody>
                                <%
                                    List<RoomBooking> rbList = BookingsDao.getBookingsJoinRoom();
                                ...
                                <tr>
                                    ...
                                    <td><h6 style="text-align: center"><%=rb.getBooking().getExpire()%></h6></td>
                                </tr>
                                <%
                                        }
                                %>
