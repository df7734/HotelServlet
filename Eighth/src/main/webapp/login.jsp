...
<div class="bg-image"
	 style="background-image: url('https://pbs.twimg.com/media/EESubW0XsAA0jPA?format=jpg&name=large');
            height: 100vh">
	<!----Login---->
	<div class="container-xxl" style="padding-top: 85px; max-width: 1050px">
		<div class="card">
			<div class="card-body">
				<div class="bg-image"
            ...
            max-height: 700px; max-width: 1000px">
				<section>
					<div class="container-sm">
						<div class="row d-flex justify-content-center align-items-center h-100" style="padding-top: 100px; padding-bottom: 100px">
							<div class="col-md-9 col-lg-6 col-xl-5 text-center">
								<img src="https://mdbcdn.b-cdn.net/img/Photos/new-templates/bootstrap-login-form/draw2.webp" class="img-fluid"
									 alt="Sample image">
									<h3 style="padding-top: 20px"><a href="registration.jsp" class="signup-image-link"><fmt:message key="label.createAcc"/></a></h3>
							</div>
							<div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
								<form method="post" action="login" class="register-form" id="login-form">
									<h1 class="form-title text-center" style="padding-bottom: 20px; color: dodgerblue"><fmt:message key="label.signIn"/></h1>
									<!-- Email input -->
									...
									<div class="form-outline mb-3">
										<label for="password" class="form-label"><fmt:message key="label.enterPass"/></label>
										<input type="password" id="password" name="password" class="form-control form-control-lg"
											   placeholder="<fmt:message key="label.password"/>" />
									</div>
									<div class="text-center text-lg-start mt-4 pt-2">
										<button type="submit" class="btn btn-primary btn-lg"
												style="padding-left: 2.5rem; padding-right: 2.5rem;"><fmt:message key="label.log_in"/></button>
									</div>
								</form>
							</div>
						</div>
