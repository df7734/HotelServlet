                                ...
                                <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
                                    <div class="carousel-inner" style=" width:100%; height: 400px !important;">
                                        <div class="carousel-item active" style="-webkit-transition: 0.2s !important; -o-transition: 0.2s !important; transition: 0.2s !important;">
                                            <img src="https://www.filoxenianews.gr/wp-content/uploads/2021/02/w-bogota-extreme-wow-suite-1024x683.jpg" class="d-block w-100" alt="...">
                                        </div>
                                        <div class="carousel-item" style="-webkit-transition: 0.2s !important; -o-transition: 0.2s !important; transition: 0.2s !important;">
                                            <img src="https://media.expedia.com/hotels/3000000/2780000/2774400/2774348/0ca04961_z.jpg" class="d-block w-100" alt="...">
                                        </div>
                                        <div class="carousel-item" style="-webkit-transition: 0.2s !important; -o-transition: 0.2s !important; transition: 0.2s !important;">
                                            <img src="https://hotelnet.cloud/hotelnetwork/assets/lh82lgm71ogw0g0s?w=960&h=960&f=contain&q=75" class="d-block w-100" alt="...">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            ...
                                            <div class="card text-center">
                                                <div class="card-body">
                                                    <h5 class="card-title text-danger text-capitalize">Book your Standard room</h5>
                                                        ...
                                                        <div class="row">
                                                            <div class="col">
                                                                <select class="form-select" name="class" id="class" aria-label="Default select example">
                                                                    <option selected="selected" hidden="hidden" value="standard">Standard</option>
                                                                    <option value="standard">Standard</option>
                                                                </select>
                                                            </div>
                                                            <div class="col">
                                                                <select class="form-select" name="capacity" id="capacity" aria-label="Default select example">
                                                                    <option selected="selected" hidden="hidden" value="1">Number of persons</option>
                    ...
                    <div class="row">
                        ...
                        <div class="col-8">
                            ...
                            <table class="table table-striped table-hover" id="sortTable">
                                ...
                                <tbody>
                                <%
                                    List<Room> list = RoomsDao.getRoomsByClass("standard");
                                    for (Room room: list) {
                                %>
                                <tr>
